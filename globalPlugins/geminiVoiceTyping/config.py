...
DEFAULT_CONFIG = {
    ...
    "corrector_prompt": "Read this text and if there is a spelling or grammar error, correct it. Ensure incorrect Haa (ه) at the end of nouns is replaced with Taa Marbouta (ة). CRITICAL: Preserve all languages, colloquial dialects (like Egyptian Arabic), and English words exactly as spoken. Do NOT translate. If the text is already correct, error-free, and well-punctuated, return it EXACTLY as is without any changes. Only output the final text, no conversational response."
}
